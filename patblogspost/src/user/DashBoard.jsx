...
import thumnail from '../assets/Anima1.png'
    ...
    return (
            <div className="py-10">
                <div
                    ...
                    <div className="left">
                        <img
                            className=" w-20 object-cover rounded-full border-2 border-pink-600 p-1"
                                ...
                                <tbody>
                                    <tr className=" border-b-2" style={{ background: mode === 'dark' ? 'rgb(30, 41, 59)' : 'white' }}>
                                        ...
                                        <th style={{ color: mode === 'dark' ? 'white' : 'black' }} scope="row" className="px-6 py-4 font-medium ">
                                            {/* thumbnail  */}
                                            <img className='w-20 rounded-lg' src={ thumnail } alt="thumbnail" />
                                        </th>
